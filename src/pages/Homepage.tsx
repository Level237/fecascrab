    ...
    <>
      ...
      {!loading &&
        <section> <section>
          ...
          <NavMobile />
          <HeroCarousel />
          <div className="max-w-7xl mt-12 max-w-[1440px] mx-auto mx-28  px-4 max-sm:mx-0 py-12">
            {/* Welcome Section */}
            <div className="flex items-center max-sm:flex-col justify-between gap-8 mb-12">
              <div className="space-y-6 w-[60%] max-sm:w-full">
                ...
                <Link to={`/origine`}><Button className='bg-red-600 mt-7  text-white px-8 py-6 text-3xl max-sm:text-2xl title-font'>En Savoir Plus</Button></Link>
              </div>
              <div className="relative max-sm:hidden h-[350px] w-[40%]">
                <img
                  src={section1}
                  alt="Partie de Scrabble en cours"
                  className="rounded-lg object-cover  w-full h-full"
