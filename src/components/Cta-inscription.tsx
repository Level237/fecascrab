  ...
  return (
    ...
    className="relative px-24 flex items-center justify-between mb-12 mx-24 max-sm:hidden mt-12 h-[300px] flex-2">
        ...
        <div className="  flex flex-col gap-4 items-center">
                    ...
                    <h2 className="text-white text-center text-5xl max-sm:text-2xl title-font font-bold">INSCRIVEZ VOUS <br />DES MAINTENANT</h2>
            <div>
    ...
    className="relative px-24 hidden  max-sm:px-0 max-sm:flex max-sm:items-end max-sm:justify-center max-sm:mx-4  items-center    mx-24  mt-12 h-[100vh] flex">
          ...
          <Link to="/inscription"><Button className="bg-red-600 text-2xl max-sm:text-2xl title-font mb-[6rem]  rounded-full text-white   py-7 px-12">S'INSCRIRE</Button></Link>
