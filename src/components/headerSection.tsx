...
export default function HeaderSection() {
  ...
  return (
    <header className={`sticky top-0 max-sm:top-0 w-full z-50 transition-colors duration-300 ${isScrolled ? 'bg-emerald-800 z-[999999]  py-4' : 'bg-transparent mt-8'
      }`}>
        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="hidden text-2xl title-font md:flex items-center space-x-8">
            ...
            <Link
              ...
              onMouseLeave={() => setIsHovered({ isOpen: false, name: "" })}
              className={`${isScrolled ? 'text-white hover:text-white' : 'text-[#00723e]'}   relative flex items-center gap-3 hover:text-white/80 font-medium`}
            >
