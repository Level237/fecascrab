...
s’exprimer et exceller à travers le Scrabble.</p>
            <div>
              ...
              <Link to="/"><Button className="bg-red-600 title-font rounded-full  text-white text-2xl  py-6 px-12">Rejoignez-nous</Button></Link>
...
s’exprimer et exceller à travers le Scrabble.</p>
          <Link to="/inscription"><Button className="bg-red-600 mb-[6rem] title-font  rounded-full text-white text-2xl  py-8 px-12">Rejoignez-nous</Button></Link>
